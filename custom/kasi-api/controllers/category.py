...
class CategoryController(http.Controller):
    ...
    @http.route('/api/categories',auth='public',type='json',methods=['POST'],cors=cros)
    ...
    @http.route('/api/categories/<int:category_id>',auth='public',type='json',methods=['POST'],cors=cros)
