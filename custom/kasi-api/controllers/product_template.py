...
class ProductTemplateController(http.Controller):
    ...
    @http.route('/api/product-templates',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/product-templates/<int:product_template_id>/',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/product-templates/<int:product_template_id>/products/',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/product-templates/<int:product_template_id>/products/<int:product_id>',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/product-templates/<int:product_template_id>/products/<int:product_id>/alternative-products',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/pricelists',auth='public',type='json',methods=['POST'],cros=cros)
    ...
    @http.route('/api/pricelists/<int:pricelist_id>/products/<int:product_id>',auth='public',type='json',methods=['POST'],cros=cros)
